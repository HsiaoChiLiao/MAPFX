...
#' @param cluster.analysis.bkb  logical; if TRUE (default), perform cluster analysis using normalised backbone markers.
#' @param plots.cluster.analysis.bkb logical; if TRUE (default), produce an UMAP embedding plot from the normalised backbone markers to visualise the structure of the biological clusters.
#' @param cluster.analysis.all logical; if TRUE (default), perform cluster analysis using normalised backbone markers and imputed infinity markers.
#' @param plots.cluster.analysis.all logical; if TRUE (default), produce an UMAP embedding plot from the normalised backbone markers and the imputed infinity markers to visualise the structure of the biological clusters.
